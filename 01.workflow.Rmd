...
The dendogram indicates that the greatest distances between grpups exist if these are grouped in three clusters
...
pca_cuc_rare <- PCA(df_pca[,3:11], ind.sup = 22:26, graph = FALSE)
summary(pca_cuc_rare)

plot_pca <- fviz_pca_biplot(pca_cuc_rare, addEllipses = F, ellipse.level = 0.95,
